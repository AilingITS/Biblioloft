...
public class agregarMisteriosFragment extends Fragment {
    ...
    public agregarMisteriosFragment() {
        // Required empty public constructor
    }

    public static agregarMisteriosFragment newInstance(String param1, String param2) {
        agregarMisteriosFragment fragment = new agregarMisteriosFragment();
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        infoMap.put("tipoLibro", "Misterios");
        ...
        adminRef.child("misterios").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
