package com.example.biblioloft.fragmentsAdmin.agregarCategorias;
...
public class agregarInfantilesFragment extends Fragment {
    ...
    public agregarInfantilesFragment() {
        // Required empty public constructor
    }

    public static agregarInfantilesFragment newInstance(String param1, String param2) {
        agregarInfantilesFragment fragment = new agregarInfantilesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_agregar_infantiles, container, false);
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        infoMap.put("tipoLibro", "Infantiles");
        infoMap.put("nombreLibro", nombre);
        infoMap.put("descripcionLibro", descripcion);
        infoMap.put("paginasLibro", paginas);

        adminRef.child("infantiles").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
