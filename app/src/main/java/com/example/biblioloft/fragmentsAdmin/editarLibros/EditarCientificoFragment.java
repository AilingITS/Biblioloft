...
public class EditarCientificoFragment extends Fragment {
    ...
    public void SaveInfoToDatabase () {
        ...
        if (TextUtils.isEmpty(nombre)) {
            editar_nombreLibro.setError("Ingrese el nombre de la comida");
            editar_nombreLibro.requestFocus();
        } else if (TextUtils.isEmpty(descripcion)) {
            editar_descripcionLibro.setError("Ingrese los ingredientes");
            editar_descripcionLibro.requestFocus();
        } else if (TextUtils.isEmpty(paginas)) {
            editar_paginasLibro.setError("Ingrese las calorías");
            editar_paginasLibro.requestFocus();
        } else {
