...
public class agregarCientificosFragment extends Fragment {
    ...
    public static agregarCientificosFragment newInstance(String param1, String param2) {
        agregarCientificosFragment fragment = new agregarCientificosFragment();
