...
public class agregarLiteraturaFragment extends Fragment {
    ...
    public agregarLiteraturaFragment() {
        // Required empty public constructor
    }

    public static agregarLiteraturaFragment newInstance(String param1, String param2) {
        agregarLiteraturaFragment fragment = new agregarLiteraturaFragment();
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        adminRef.child("literatura").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
