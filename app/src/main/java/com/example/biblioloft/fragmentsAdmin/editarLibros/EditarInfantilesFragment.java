...
public class EditarInfantilesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dbRef.child("infantiles").child(libroID).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        dbRef.child("infantiles").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    public void SaveInfoToDatabase () {
        ...
        if (TextUtils.isEmpty(nombre)) {
            ...
            dbRef.child("infantiles").child(libroID).updateChildren(desayunoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull @NotNull Task<Void> task) {
                    if (task.isSuccessful()) {
