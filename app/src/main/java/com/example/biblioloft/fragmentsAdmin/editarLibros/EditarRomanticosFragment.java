...
public class EditarRomanticosFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dbRef.child("romanticos").child(libroID).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        dbRef.child("romanticos").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
