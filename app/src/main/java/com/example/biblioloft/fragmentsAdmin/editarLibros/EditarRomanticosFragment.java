...
import com.example.biblioloft.fragmentsAdmin.registroLibros.registroRomanticosFragment;
...
public class EditarRomanticosFragment extends Fragment {
    ...
    public EditarRomanticosFragment(String libroID) {
        this.libroID = libroID;
    }

    public EditarRomanticosFragment() {
        // Required empty public constructor
    }

    public static EditarRomanticosFragment newInstance(String param1, String param2) {
        EditarRomanticosFragment fragment = new EditarRomanticosFragment();
    ...
    private void ValidateProductData() {
        ...
        if (ImageUri == null) { //En caso que el usuario modifico datos pero no su imagen se llama a la sig función solo para actualizar datos
            ...
            StorageReference fileRef = ImagesRef.child("romanticos").child(imgID + ".jpg");
        ...
        dbRef.child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    replaceFragment(new registroRomanticosFragment());
                } else {
