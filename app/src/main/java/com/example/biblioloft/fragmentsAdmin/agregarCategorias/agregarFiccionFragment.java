...
public class agregarFiccionFragment extends Fragment {
    ...
    public agregarFiccionFragment() {
        // Required empty public constructor
    }

    public static agregarFiccionFragment newInstance(String param1, String param2) {
        agregarFiccionFragment fragment = new agregarFiccionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_agregar_ficcion, container, false);
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        adminRef.child("ficcion").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
