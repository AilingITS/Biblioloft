...
import com.example.biblioloft.fragmentsAdmin.registroLibros.registroMisterioFragment;
...
public class EditarMisterioFragment extends Fragment {
    ...
    public EditarMisterioFragment(String libroID) {
        this.libroID = libroID;
    }

    public EditarMisterioFragment() {
        // Required empty public constructor
    }

    public static EditarMisterioFragment newInstance(String param1, String param2) {
        EditarMisterioFragment fragment = new EditarMisterioFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_editar_misterio, container, false);
    ...
    private void ValidateProductData() {
        ...
        if (ImageUri == null) { //En caso que el usuario modifico datos pero no su imagen se llama a la sig función solo para actualizar datos
            ...
            StorageReference fileRef = ImagesRef.child("misterios").child(imgID + ".jpg");
        ...
        dbRef.child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull @NotNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    replaceFragment(new registroMisterioFragment());
                } else {
