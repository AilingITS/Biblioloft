...
public class agregarTerrorFragment extends Fragment {
    ...
    public agregarTerrorFragment() {
        // Required empty public constructor
    }

    public static agregarTerrorFragment newInstance(String param1, String param2) {
        agregarTerrorFragment fragment = new agregarTerrorFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vista = inflater.inflate(R.layout.fragment_agregar_terror, container, false);
    ...
    private void SaveInfoToDatabasewithoutImage () {
        ...
        infoMap.put("tipoLibro", "Terror");
        infoMap.put("nombreLibro", nombre);
        infoMap.put("descripcionLibro", descripcion);
        infoMap.put("paginasLibro", paginas);

        adminRef.child("terror").child(libroID).updateChildren(infoMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
